...
var project             = 'Primax Properties'; // Project Name.
var projecturl          = 'http://localhost:8888/Bellaworks/primax/site/bw'; // Project URL. Could be something like localhost:8888.
...
gulp.task( 'vendorsJs', function() {
	...
	gulp.src( [
		...
		//'./assets/js/vendors/jquery.vmap.min.js',
		//'./assets/js/vendors/jquery.vmap.usa.js'
		] )
